...
import { ListSendEmails } from "../../../services";
import type { SendEmailInterface } from "../../../interface/ISendEmail";
import ModalEditSendEmail from "./editservice";
...
const ServiceContactCenter: React.FC = () => {
    ...
    const fetchFirstSendEmail = async () => {
        ...
        try {
            ...
            if (res && res.length > 0) {
                setSendEmail(res[0]); // ใช้เรคอร์ดแรกตาม requirement
            } else {
                setSendEmail(null);
            }
        } finally {

...
interface EditSendEmailModalProps {
  open: boolean;
  onClose: () => void;
  record?: SendEmailInterface | null;             // ข้อมูลปัจจุบัน (ใช้เฉพาะ ID แรก)
  onUpdated: (updated: SendEmailInterface) => void; // callback หลังอัปเดตสำเร็จ
}
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <label className="flex flex-col gap-1">
                ...
                <span className="text-[11px] text-slate-500">
                  ใช้รหัสผ่านแอปของ Gmail (ต้องเปิด 2-Step Verification และสร้าง App password)
                </span>
              </label>
            </div>
          </div>
